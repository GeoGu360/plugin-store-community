...
pub async fn get_allowance(
    ...
    // Take last 32 hex chars (16 bytes) to avoid u128 overflow
...
/// NonfungiblePositionManager.positions(uint256) → (nonce, operator, token0, token1, fee,
...
pub async fn nfpm_positions(
    ...
    // Layout: nonce(0) operator(1) token0(2) token1(3) fee(4) tickLower(5) tickUpper(6)
