---
name: sky-lending
description: Sky Lending (MakerDAO CDP) — manage collateralized debt positions on Ethereum. Deposit ETH/WBTC collateral, borrow DAI stablecoins, repay debt, and withdraw collateral. Supports listing ilks (collateral types) and viewing vault positions. All write operations are dry-run for safety (CDP liquidation risk).
---
